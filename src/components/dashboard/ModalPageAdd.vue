...
async function pageAdd() {
    ...
    const dataToSend = {
        router: formData.value.router,
        title: formData.value.title,
        styles: styles // Envía esto como una cadena JSON al backend
    };

    pageStore.addPage(dataToSend);
    modal.handleClickModalPageAdd();
}
</script>

<template>
     <div class="modal" v-if="modal.modalPageAdd">
    <div class="modal__contenido">
      ...
      <hr />
      <!-- modal contenido -->
      <form @submit.prevent="pageAdd" class="formulario">
        ...
        <div class="formulario__campo">
          <label for="comun" class="formulario__label">Título</label>
          <input
