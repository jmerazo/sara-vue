...
<template>
    <div class="border shadow-lg">
        <div class="overflow-hidden">
            <img 
                class="hover:scale-110  transition-transform hover:rotate-1"
        ...
        <div class="p-5">
            ...
            <button 
                type="button"
                class="w-full bg-green-600 hover:bg-green-900 text-white rounded-lg p-2 mt-3 mb-4 font-bold text-2xl"
                @click="especies.seleccionarEspecie(especie.nom_comunes)"
            >
                Ver Especie
            </button>
        </div>
