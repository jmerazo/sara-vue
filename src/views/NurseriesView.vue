        ...
        <div class="header__form">
          ...
          <div class="form" :class="{ 'isSearching': isSearching }">
            ...
            <div class="form__icon">
              <svg :style="{ color: isSearching ? 'white' : 'var(--gris)' }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <article class="card" v-for="nursery in nurseries.paginatedNurseries" :key="nursery.id">
          <div class="card__image-container">
            <div class="card__image">
              <img :src="nursery.image_url || '/img/no_img_nurseries.png'" :alt="nursery.nombre_vivero"
                class="nursery-image">
            </div>
          </div>
          <div class="card__contact">
            <div class="card__information">
              ...
              <div class="information">
                ...
                <a style="color: var(--primary); margin-top: 1rem"
            ...
            <div class="buttons__information">
              <RouterLink class="card__button" :to="{ name: 'nursery' }" @click="nurseries.getNursery(nursery)">
                Especies
              </RouterLink>
            </div>
          </div>
