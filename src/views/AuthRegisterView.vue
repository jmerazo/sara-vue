...
const submitForm = () => {
  // Aquí puedes enviar los datos del formulario a través de una solicitud HTTP o realizar otras acciones según tus necesidades.
  // Los datos del formulario estarán disponibles en formData.value.
};
</script>
...
<template>
    <div class="max-w-md mx-auto">
      ...
      <form @submit.prevent="submitForm" class="space-y-4 mb-20 relative bg-white p-8 rounded-lg shadow-lg backdrop-blur-lg backdrop-opacity-50">
        <!-- Tipo de documento -->
        <div>
          <label for="tipoDocumento" class="block font-semibold mb-1">Tipo de documento</label>
          <select v-model="formData.tipoDocumento" id="tipoDocumento" class="w-full rounded-lg border px-4 py-2">
        ...
        <div>
          ...
          <input v-model="formData.numeroDocumento" type="text" id="numeroDocumento" class="w-full rounded-lg border px-4 py-2" required>
        </div>
